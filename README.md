...
* [DeepSeek-R1 (671B)](https://github.com/deepseek-ai/DeepSeek-R1) ⭐ 92,035 | 🐛 36 | 📅 2025-06-27 - Announced by DeepSeek / 2025
...
* [Visual ChatGPT](https://github.com/microsoft/visual-chatgpt) ⭐ 34,010 | 🐛 261 | 🌐 Python | 📅 2024-01-06 - Announced by Microsoft / 2023
...
* [StableLM](https://github.com/Stability-AI/StableLM) ⭐ 15,685 | 🐛 27 | 🌐 Jupyter Notebook | 📅 2024-04-08 - Maintained by Stability AI / 2023
...
* [AutoGPT](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 186,687 | 🐛 509 | 🌐 Python | 📅 2026-08-19 - ![Repo stars of Significant-Gravitas/Auto-GPT](https://img.shields.io/github/stars/Significant-Gravitas/Auto-GPT?style=social) - An experimental open-source attempt to make GPT-4 fully autonomous.
* [DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1) ⭐ 92,035 | 🐛 36 | 📅 2025-06-27 - ![Repo stars of deepseek-ai/DeepSeek-R1](https://img.shields.io/github/stars/deepseek-ai/DeepSeek-R1.svg?style=social) - A first-generation reasoning model from DeepSeek-AI.
* [Embedchain](https://github.com/embedchain/embedchain) ⭐ 63,607 | 🐛 690 | 🌐 Python | 📅 2026-08-18 - ![Repo stars of embedchain/embedchain](https://img.shields.io/github/stars/embedchain/embedchain.svg?style=social) - Framework to create ChatGPT like bots over your dataset.
* [llama\_index](https://github.com/jerryjliu/llama_index) ⭐ 51,745 | 🐛 641 | 🌐 Python | 📅 2026-08-19 - ![Repo stars of jerryjliu/llama\_index](https://img.shields.io/github/stars/jerryjliu/llama_index?style=social) - A project that provides a central interface to connect your LLM's with external data.
...
* [openai/evals](https://github.com/openai/evals) ⭐ 19,203 | 🐛 225 | 🌐 Python | 📅 2026-04-14 - ![Repo stars of openai/evals](https://img.shields.io/github/stars/openai/evals?style=social) - A curated list of reinforcement learning with human feedback resources.
...
* [google-deepmind/gemma](https://github.com/google-deepmind/gemma) ⭐ 5,671 | 🐛 315 | 🌐 Python | 📅 2026-08-10 - ![Repo stars of google-deepmind/gemma](https://img.shields.io/github/stars/google-deepmind/gemma.svg?style=social) - Open weights LLM from Google DeepMind.
...
* [pythia](https://github.com/EleutherAI/pythia) ⭐ 2,886 | 🐛 26 | 🌐 Jupyter Notebook | 📅 2025-11-15 - ![Repo stars of EleutherAI/pythia](https://img.shields.io/github/stars/EleutherAI/pythia?style=social) - A suite of 16 LLMs all trained on public data seen in the exact same order and ranging in size from 70M to 12B parameters.
